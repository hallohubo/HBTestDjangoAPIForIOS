...
- (void)commonInit
{
    ...
    self.effect = HB3DScrollViewEffectNone;
}

- (void)setEffect:(HB3DScrollViewEffect)effect
{
    self->_effect = effect;
    switch (effect) {
        case HB3DScrollViewEffectTranslation:
            self.angleRatio = 0.;
            self.rotationX  = 0.;
            self.rotationY  = 0.;
            self.rotationZ  = 0.;
            ...
            self.translateY = .25;
            break;
        case HB3DScrollViewEffectDepth:
            self.angleRatio = .2;
            self.rotationX  = 0;
            self.rotationY  = 1.;
            self.rotationZ  = 0.;
            ...
            self.translateY = 0.;
            break;
        case HB3DScrollViewEffectCarousel:
            self.angleRatio = .5;
            self.rotationX  = -1.;
            self.rotationY  = 0.;
            self.rotationZ  = 0.;
            ...
            self.translateY = .25;
            break;
        case HB3DScrollViewEffectCards:
            self.angleRatio = .5;
            self.rotationX  = -1.;
            self.rotationY  = -1.;
            self.rotationZ  = 0.;
...
- (void)layoutSubviews
{
    ...
    for(UIView *view in self.subviews){
        ...
        CGFloat angle       = distanceFromCenterX * 0.05;
